...
//        }
        ...
        Element configuration = node.element("environments");

        Element environment = configuration.element("environment");
        Element element = environment.element("dataSource");
